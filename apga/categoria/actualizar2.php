...
<div class="container text-center py-2">
      <form action="actualizar.php?id=<?php echo $id ?>" method="post">
        ...
        <input autocomplete="off" class="form-control-sm formul text-center" id="categoria" type="text" name="categoria" placeholder="nombre" required oninvalid="this.setCustomValidity('Ingresa el nombre')"><br><br>
