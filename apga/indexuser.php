...
<div class="container-fluid bg-success py-4 text-left text-light">
 <div class="container">
  <!--  <h1>APGA</h1>-->
   ...
   <div class="container">
    <a class="text-light" href="categoria/index.php"><button class="btn btn-success">CATEGORIAS</button></a><br>
  </div>
  <div class="container">
   <a class="text-light" href="proveedor/index.php"><button class="btn btn-success">PROVEEDORES</button></a><br>
  </div>
   <div class="container">
  <a class="text-light" href="registro/index.php"><button class="btn btn-success">PRODUCTOS</button></a><br>
  </div>
 
     <div class="container">
  <a class="text-light" href="movimientos/index.php"><button class="btn btn-success">MOVIMIENTOS</button></a><br>
  </div>
...
<button class="btn btn-success"><a class="text-light" href="cerrar_sesion.php">SALIR</a></button><br>
</div>
